...
@RestController
@RequestMapping("/api/jala-bot-kafka")
public class JalaBotKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JalaBotKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JalaBotKafkaResource(KafkaProperties kafkaProperties) {
